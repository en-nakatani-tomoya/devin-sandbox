...
class OpenAIMock:
    """
    Mock implementation of the OpenAI interface.
    This class simulates the behavior of the OpenAI API for development purposes.
    """
    ...
    def __init__(self):
        ...
        self.templates = [
            ...
            "1. The primary factors involved are related to economic and environmental considerations.\n"
